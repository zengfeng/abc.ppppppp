package test
{
	...
	public class TestComboBox extends Game
	{
		...
		private function addComboBox() : void
		{
			...
			_comBoBox.model.source = [new LabelSource("<font color='" + "#ffee00" + "'>" + "1级强化石" + "</font>",1), new LabelSource("2级强化石",2), new LabelSource("3级强化石",3), new LabelSource("4级强化石",4), new LabelSource("5级强化石",5), new LabelSource("6级强化石",6), new LabelSource("7级强化石",7)];
		...
		{
//			//trace(event.text);
			_comBoBox.model.source = [new LabelSource("2级强化石",2), new LabelSource("3级强化石",3), new LabelSource("4级强化石",4), new LabelSource("5级强化石",5), new LabelSource("6级强化石",6), new LabelSource("7级强化石",7)];
