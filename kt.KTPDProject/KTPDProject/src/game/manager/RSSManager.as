package game.manager {
	...
	public final class RSSManager
	{
		...
		public function startLoad() : void
		{
			...
			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/avatar/shadow.png"), "shadowPng0")));
			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/avatar/shadow1.png"), "shadowPng1")));
			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/quest/quest.swf"), "quest")));
			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/swf/embedFont_" + StaticConfig.langString + ".swf"), "embedFont")));
			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/swf/commonAction_" + StaticConfig.langString + ".swf"), "commonAction")));
//			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/swf/profession.swf"), "profession")));
			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/swf/smallLoader.swf"), "smallLoader")));
			_res.add(new SWFLoader(new LibData(VersionManager.instance.getUrl("assets/swf/titleFont.swf"))));
			...
			// 强化面板
			url = VersionManager.instance.getUrl("assets/avatar/184549377.swf");
			_res.add(new SWFLoader(new LibData(url, url, true, false), AvatarManager.instance.getAvatarBD(184549377).parse, [url]));
		}
