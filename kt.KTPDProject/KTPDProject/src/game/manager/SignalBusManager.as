...
//		public static var playerLevelChange:Signal = new Signal(/* old */ uint, /* new */ uint);
		...
		public static var levelUp:RequestData=new RequestData(0xFFF5, CCHeroPanelOpen);
		...
		//悬赏
		//----------------------------------------------------------------
		public static var questPanelAcceptMissionUpdate:Signal = new Signal(uint);
		public static var questPanelEndMissionUpdate:Signal = new Signal(uint,uint);
