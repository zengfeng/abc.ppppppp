package game.core.hero
{
	...
	public class HeroManager
	{
		...
		private static var _propV : Array = ["strength", "quick", "physique"/** 三个基础属性 */, "hp", "act", "magic_act", "def", "speed", "gauge_initial", "hit", "dodge", "crit", "pierce", "counter"/** 11个二级属性 */, "hp_add", "act_add", "hp_per", "act_per", "speed_per", "magic_per"/** 二级属性附加*/, "predef", "magic_pierce", "critmul", "piercedef", "countermul", "harm", "gauge_initial"/** 特殊属性 */];
		...
		public static function calculateHeroProp(hero : VoHero, profLevel : int, formationProp : ItemProp) : VoHeroProp
		{
			...
			if (value)
			{
				...
				for each (_propV in potentialProp)
				{
		...
		public function calculateBattlePower(prop : VoHeroProp) : Number
		{
			/**
