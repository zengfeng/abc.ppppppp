package game.core.item
{
	...
	public class ItemService
	{
		...
		private var _rollQueue : Dictionary;
		 ...
		 * 处理物品改变
		 */
		private function processCommonItemChange(key : uint) : void
		{
			var id : uint = key & 0x7FFF;
			var num : uint = (key & 0x7FFF0000) >> 16;
			var binding : Boolean = (key >> 15 & 0x1) != 0;
			var roll : Boolean = (key >> 31 & 0x1) != 0;
		 ...
		 * 处理装备改变
		 */
		private function processEquipItemChange(attr : EquipAttribute) : void
		{
