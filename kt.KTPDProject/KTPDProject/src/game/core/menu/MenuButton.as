	...
	public class MenuButton extends GButton implements IMenuButton
	{
		...
		private function initClass() : void
		{
			...
			if (_class)
			{
				...
				if (_target is IAssets)
				{
					_isBusy = true;
					var arr : Array = (_target as IAssets).getResList();
					var libData : LibData;
					...
					Common.getInstance().moduleLoader.startShow("");
				}
