package game.module.mapStory
{
    ...
    {
        function StoryController1(singleton : Singleton) : void
        {
            singleton;
        }

        /** 单例对像 */
        private static var _instance : StoryController1;

        /** 获取单例对像 */
        public static function get instance() : StoryController1
        {
            if (_instance == null)
            {
                _instance = new StoryController1(new Singleton());
            }
            return _instance;
        }
