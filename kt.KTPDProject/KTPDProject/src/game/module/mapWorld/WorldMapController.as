package game.module.mapWorld
{
    ...
    public class WorldMapController
    {
        ...
        private var _worldMapPlayer : WorldMapPlayer;

        private function get worldMapPlayer() : WorldMapPlayer
        {
            if (_worldMapPlayer == null)
            {
                _worldMapPlayer = WorldMapPlayer.instance;
            }
            return _worldMapPlayer;
        }

        private var _mapProto : MapProto;

        private function get mapProto() : MapProto
        {
            if (_mapProto == null)
            {
                _mapProto = MapProto.instance;
            }
            return _mapProto;
        }
