...
//          addTimePanel();
        ...
        {
            var userlist_big_bg:Sprite = UIManager.getUI(new AssetData(UI.COMPETE_USERLIST_BIG_BACKGROUND));
            userlist_big_bg.width = 1220.95;
            userlist_big_bg.height = 268.25;
            _content.addChild(userlist_big_bg);
			
            var userlist_small_bg:Sprite = UIManager.getUI(new AssetData(UI.COMPETE_USERLIST_SMALL_BACKGROUND));
...
//////////////////////////////////////////////////////////////////////////////////////		
		...
		private function updateCard():void
		{
            ...
            {  
				...
				{
				 (_userItems[i] as UserItem).upDateUserItem(job, name, rank.toString(), level, color,true);
				}
				else
				{
				(_userItems[i] as UserItem).upDateUserItem(job, name, rank.toString(), level, color);
				}
                i++;
            }
			while(i<MaxUser)
			{
			    (_userItems[i] as UserItem).upDateUserItem(0, "","", 0,0,false,false,false);
				i++;
			}
...
//////////////////////////////////////////////////////////////////////////////////////		
		...
		private function refreshChTime(msg:SCAthleticsBuy):void
		{
			...
			return;
			var count:uint=msg.todayCountLeft;
