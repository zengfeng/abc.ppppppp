package game.module.quest
{
	...
	public class QuestDisplayManager
	{
		...
		{
			if (QuestManager.getInstance().isSubmit(101009))return;
			_questList = arr;
		...
		private function onClick(event : MouseEvent) : void
		{
			...
			{
				FollowManager.instance.removeNpcFollowSelf(_currnVo.base.npcPublish);
				QuestUtil.removeQuestMode();
			}
			if (!_currnVo.isCompleted)
			{
				(AnimalManager.instance.selfPlayer.avatar as AvatarMySelf).questAccept();
