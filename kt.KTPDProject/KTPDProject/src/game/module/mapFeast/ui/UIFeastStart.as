package game.module.mapFeast.ui {
	 ...
	 * @author 1
	 */
	public class UIFeastStart extends GPanel implements FeastUI{
		...
		public function initButton():void
		{
			...
			_startBtn.x = -4 ;
			_startBtn.y = -4 ;
			_ableText = UIManager.getUI(new AssetData(FeastConfig.FEAST_START_TEXT , "embedFont"));
			_ableText.x = 9 ;
			_ableText.y = 74 ;
			addChild(_startBtn);
			...
			pdata.width = width ;
			pdata.height = height ;
			pdata.bgAsset = new AssetData( FeastConfig.FEAST_START_DOWN, "embedFont" ); 
			_disPanel = new GPanel(pdata);
			_disPanel.filters = [FilterUtils.disableFilter()];
			_disableText = UIManager.getUI(new AssetData(FeastConfig.FEAST_START_DISABLE, "embedFont"));
			_disableText.x = 5 ;
			_disableText.y = 70 ;
