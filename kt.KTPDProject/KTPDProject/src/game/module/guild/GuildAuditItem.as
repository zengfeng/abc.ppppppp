package game.module.guild {
	...
	public class GuildAuditItem extends Sprite {
		...
		private function addBg():void {
			...
			deepbg = UICreateUtils.createSprite(GuildUtils.clanDeepBar , 423,25,0,0);
			lightbg = UICreateUtils.createSprite(GuildUtils.clanLightBar , 423,25,0,0);
			addChild(deepbg);
		}
...
//			font.color =  ColorUtils.PANELTEXT0X ;
			...
			nameText = UICreateUtils.createTextField(null,null,135,25,0,2,font);
			...
			levelText = UICreateUtils.createTextField(null,null,24,25,140,2,font);
			levelText.selectable = false ;
			addChild(levelText);
			
			rankText = UICreateUtils.createTextField(null,null,130,25,170,2,font) ;
