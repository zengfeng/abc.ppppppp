...
//			fmt.color =  ColorUtils.PANELTEXT0X ;
			var tip:TextField = UICreateUtils.createTextField("家族名称最多为12个字符",null,138,18,33,42,fmt);
			addChild(tip);
			// _nameInput = new DefaultInput(12, 46 + dy, 175, 25);
			_nameInput = UICreateUtils.createGTextInput({x:12, y:17, width:175, height:25, hintText:"请输入想要创建的家族名称", maxChars:12});
			addChild(_nameInput);
...
//		}
		...
		{
			return FilterTextUtils.checkStr(_nameInput.text) ;
		}
