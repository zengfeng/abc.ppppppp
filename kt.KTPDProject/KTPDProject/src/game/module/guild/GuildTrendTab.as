package game.module.guild {
	...
	public class GuildTrendTab extends GPanel
	{
		...
		private function addBg() : void
		{
			...
			var line:Sprite = UICreateUtils.createSprite( GuildUtils.brightLine,424,2,10,29 );
			addChild(line);
...
//		fmt.align = TextFormatAlign.LEFT ;
		...
		_infotxt = UICreateUtils.createTextField(null,null,380,25,2,5,fmt);
		addChild(_infotxt);
		
		_timetxt = UICreateUtils.createTextField(null,null,70,25,width - 80 , 5, fmt);
		addChild(_timetxt);
	}

	private function addbg() : void {
		_deepbg = UICreateUtils.createSprite( GuildUtils.clanDeepBar , 423, 25 );
		_lightbg = UICreateUtils.createSprite( GuildUtils.clanLightBar , 423, 25 );
		addChild(_deepbg);
	}
