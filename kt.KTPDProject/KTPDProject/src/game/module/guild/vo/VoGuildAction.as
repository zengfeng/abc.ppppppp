package game.module.guild.vo {
	...
	public class VoGuildAction {
		...
		private static const STATE_MASK:Array = [0,3,0,3];
		private static const STATE_BIT:Array = [0,0,0,2];
		private static const CONFIG_MASK:Array = [0,63,0,0] ;
		private static const CONFIG_BIT:Array = [0,0,0,0] ;
		private static const REMAIN_MASK:Array = [0,1,0,1] ;
		private static const REMAIN_BIT:Array = [0,0,0,1] ;
