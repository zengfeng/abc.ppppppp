package game.module.guild.action
{
	...
	public class CavernSetTimeWnd extends GCommonSmallWindow {
		...
		protected function initView():void{
			...
			bossimg.url = VersionManager.instance.getUrl("assets/img/monster/1.png");
			bossimg.x = 76 + bossimg.width  ;
			bossimg.y = -12 ;
...
//			_contentPanel.addChild(label);
		...
		{
			var vo:VoGuildAction = _manager.actiondata[1];
			var sel:int ;
			...
			_confirm.enabled = vo != null && vo.state != 2 && vo.state != 1;
			updateIntroText() ;
		}
		...
		public function onClickButton( evt:Event ):void
		{
			...
			else 
			{
				...
				msg.weekday = uint( _radioSel.name )|(vo.guildremain==0?8:0);
		...
		{
			var vo:VoGuildAction = GuildManager.instance.actiondata[1];
