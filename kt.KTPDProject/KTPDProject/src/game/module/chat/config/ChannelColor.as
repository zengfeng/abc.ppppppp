package game.module.chat.config
{
	...
	public class ChannelColor
	{
		...
		/** 家族 频道 */
		public static var CLAN:int = 0xeb6877;
		/** 私聊 频道 */
		public static var WHISPER:int = 0x22ac38;
		/** 系统 频道 */
		public static var SYSTEM:int = 0x7ecef4;
		/** 大喇叭 频道 */
		public static var NOTIC:int = 0xeb6100;
		/** 提示 频道 */
		public static var PROMPT:int = 0xFF00FF;
		/** 系统通告 频道 */
		public static var SYSTEM_NOTIC:int = 0xffe400;
