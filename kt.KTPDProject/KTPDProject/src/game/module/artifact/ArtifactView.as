package game.module.artifact
{
	 ...
	 * @author yangyiqiang
	 */
	public class ArtifactView extends GComponent implements IModuleInferfaces ,IAssets
	{
		...
		{
			return [new LibData(StaticConfig.cdnRoot + "assets/swf/artifact.swf", "artifact"), new LibData(StaticConfig.cdnRoot + "assets/ui/numberTest.swf", "artfactNum")];
		}
		...
		override protected function onShow() : void
		{
			...
			ToolTipManager.instance.registerToolTip(_infoText, SmallTip, "神器属性对"+StringUtils.addColor("竞技场、蜀山论剑、仙龟拜佛",ColorUtils.HIGHLIGHT_DARK)+"等系统有效");
		}
