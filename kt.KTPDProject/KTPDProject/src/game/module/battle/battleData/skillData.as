...
package game.module.battle.battleData
{
	public class skillData
	{
		...
		private var _needbuff:Number;       //0：表示没有buff  >0: 表示有buff   举例：21.111 （小数点第一位：1表示上层 2表示下层  第二位：1表示头顶位置 2表示叠在身上 第三位：1表示表示动态循环播放 2表示播放到最后一帧）
		...
		public function skillData(id:uint = 0, needbuff:uint = 0, atkid:uint = 0, rd:uint = 0, pb:Number = 0.0, vec:Array = null)
		{
			skillID = id;
			_needbuff = needbuff;
			atkID = atkid;
