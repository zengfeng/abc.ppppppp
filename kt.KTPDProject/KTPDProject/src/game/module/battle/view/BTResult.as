package game.module.battle.view
{
	...
	public class BTResult extends GComponent
	{
		...
		public function setTextResult(sysType:uint, result:uint, res:resultData):void
		{
			...
			else if(sysType == BTSystem.FT_BOSS || sysType == BTSystem.FT_GUILDDUGEON)  //boss战,家族寻宝
			{
				if(result == 1)
				{
				    _textResult.htmlText = "<font size='12' color='#2F1F00'>"+ "你对BOSS造成了</font>" + "<font color = '#279F15'>"+ "100%" + "</font>" + 
			...
			else if(sysType == BTSystem.FT_GUARD || sysType == BTSystem.FT_GBODYGUARD )   //运镖(要分打劫别人和被别人打劫s)， 家族运镖
			{
