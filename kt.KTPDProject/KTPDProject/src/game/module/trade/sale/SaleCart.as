...
//			addTextFiled("寄售价格:", TextFormatAlign.CENTER, 56, 18.5, 74, 90, 12, 0x2f1f00);
			...
			addChild(_title2);
			_titleCount=UICreateUtils.createTextField("寄售数量:",null,56, 18.5, 74, 64,TextFormatUtils.panelContent);			
			addChild(_titleCount);
			_titlePrice=UICreateUtils.createTextField("寄售价格:",null,56, 18.5, 74, 90,TextFormatUtils.panelContent);			
			addChild(_titlePrice);
			
			_countText = UICreateUtils.createGTextInput({text:"1", width:70, x:135, y:62, restrict:"0-9", maxChars:2, selectAll:true, indent:20});
			_priceText = UICreateUtils.createGTextInput({text:"", width:70, x:135, y:88, restrict:"0-9", maxChars:6, selectAll:true, indent:20});
