...
//			data.borderAsset = new AssetData(SkinStyle.emptySkin);
		...
		{
			addChild(UICreateUtils.createTextField("交易对象", null, 150, 19, 53, 35, TextFormatUtils.content));
			addChild(UICreateUtils.createTextField("交易留言", null, 200, 19, 228, 35, TextFormatUtils.content));
			addChild(UICreateUtils.createTextField("交易状态", null, 200, 19, 428, 35, TextFormatUtils.content));
			addChild(UICreateUtils.createTextField("操作", null, 110, 19, 592, 35, TextFormatUtils.content));
		}
