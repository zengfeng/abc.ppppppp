package game.module.trade.exchange
{
	...
	public class ShoppingCart extends GComponent
	{
		...
		{
			 _messageInput = UICreateUtils.createGTextInput({width:168, height:42, x:19, y:218, hintText:"可输入给对方的留言", maxChars:40, wordWrap:true, indent:40});
			addChild(_messageInput);

			addChild(UICreateUtils.createTextField(null, "<b>留言：</b>", 0, 0, 22, 223));
		}
