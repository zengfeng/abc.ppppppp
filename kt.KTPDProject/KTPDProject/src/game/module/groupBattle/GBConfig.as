package game.module.groupBattle
{
    ...
    {
		/** 组A颜色 */
		public static const GROUP_COLOR_A:uint = 0xFF3366;
		/** 组B颜色 */
		public static const GROUP_COLOR_B:uint = 0x218712;
		/** 组A颜色字符串 */
		public static const GROUP_COLOR_STR_A:String = "#FF3366";
		/** 组B颜色字符串 */
		public static const GROUP_COLOR_STR_B:String ="#218712"; 
        /** 鼓舞最大等级 */
