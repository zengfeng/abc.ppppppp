package game.module.groupBattle.ui
{
	...
	public class UiNewsPanel extends GComponent
	{
		...
		/** 添加战斗动态消息 */
		public function appendBattleNews(msg : SCGroupBattleUpdate) : void
		{
...
import game.module.groupBattle.GBNewsHTML;
import game.net.data.StoC.SCGroupBattlePlayerLost;
import game.net.data.StoC.SCGroupBattleUpdate;
...
//		tf.filters = UIManager.getEdgeFilters(0x000000);
	...
	public function appendBattleNews(msg : SCGroupBattleUpdate) : void
	{
		...
		var newsList : Vector.<String> = GBNewsHTML.getBattleNewsList(msg);
	...
	public function appendEmptyWaitNews(msg : SCGroupBattlePlayerLost) : void
	{
		...
		appendHtmlText(GBNewsHTML.getEmptyWaitNews(msg));
	}
	...
	private function testHtml() : void
	{
		...
		{
			var str : String = GBNewsHTML.player("大海明月" + i, i);
			appendHtmlText(str);
		}
	}
