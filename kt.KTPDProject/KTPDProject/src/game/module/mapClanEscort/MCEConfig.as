package game.module.mapClanEscort
{
    ...
    public class MCEConfig
    {
        ...
        /** 路线Avatar配置 */
        private static var _pathAvatarDic : Dictionary ;

        /** 路线Avatar配置 */
        private static function get pathAvatarDic() : Dictionary
        {
            if (_pathAvatarDic == null)
            {
                _pathAvatarDic = new Dictionary();
//                _pathAvatarDic[0] = 4150;
//                _pathAvatarDic[1] = 4154;
                _pathAvatarDic[0] = 3005;
                _pathAvatarDic[1] = 3006;
            }
            return _pathAvatarDic;
        }

        /** 获取AvatarID */
        public static function getAvatarId(pathId : int) : int
        {
            return pathAvatarDic[pathId];
        }
    }
}
