package game.module.gem.merge
{
	...
	public class GemMergePanel extends GemChildPanel
	{
		...
		private function addHint() : void
		{
			...
			var hintText : TextField = UICreateUtils.createTextField("三个同等级同类灵珠能合成至下一级", null, 200, 0, 38, 13, TextFormatUtils.panelContent);
			addChild(hintText);
		}
		...
		{
			var title : TextField = UICreateUtils.createTextField("灵珠列表", null, 0, 0, 343, 9, TextFormatUtils.panelSubTitle);
			_content.addChild(title);
		}
