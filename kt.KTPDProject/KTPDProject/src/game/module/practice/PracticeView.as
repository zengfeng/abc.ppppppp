package game.module.practice
{
	...
	import game.module.map.animal.AnimalStatus;
	...
	public final class PracticeView extends GPanel
	{
		...
		public function showOnly() : void
		{
			...
			if (AnimalManager.instance.selfPlayer)
				AnimalManager.instance.selfPlayer.practic();
			timeFun();
		...
		{
			if (AnimalManager.instance.selfPlayer && AnimalManager.instance.selfPlayer.status == AnimalStatus.PRACTICE)
			{
				AnimalManager.instance.selfPlayer.stand();
			}
			super.hide();
