package game.module.daily
{
	...
	import game.module.daily.transanim.AnimationId;
	import game.module.daily.transanim.KeyFrameAnimation;
...
//			data.height = 63 ;
		...
		{	
			...
			_effect = RESManager.getMC(new AssetData(UI.FIRE_CIRCLE));
			_effect.x = 4 ;
			_effect.y = 4 ;
			_effect.scaleX = 0.65 ;
			_effect.scaleY = 0.65 ;
