package game.module.rewardPackage
{
	...
	public class GiftPackageItem extends GComponent
	{
		...
		{
			if (_nameText) return;
			_nameText = UICreateUtils.createTextField(null, StringUtils.addBold(_vo.icoButton.name), 120, 25, 50, 18, UIManager.getTextFormat(14, 0x2f1f00, TextFormatAlign.CENTER));
