package game.net.data.StoC {
	...
	public dynamic final class PropertyB extends com.protobuf.Message {
		...
		override public final function writeToBuffer(output:com.protobuf.WritingBuffer):void {
			...
			com.protobuf.WriteUtils.write$TYPE_UINT32(output, spelldmg);
			com.protobuf.WriteUtils.writeTag(output, com.protobuf.WireType.VARINT, 15);
			com.protobuf.WriteUtils.write$TYPE_UINT32(output, defend);
			...
			if (hasFormationid) {
				com.protobuf.WriteUtils.writeTag(output, com.protobuf.WireType.VARINT, 29);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 14:
					...
					++spelldmg$count;
					spelldmg = com.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 15:
					if (defend$count != 0) {
					...
					++defend$count;
					defend = com.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 16:
					if (hitrate$count != 0) {
