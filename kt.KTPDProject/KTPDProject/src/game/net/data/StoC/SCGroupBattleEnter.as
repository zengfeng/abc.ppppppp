package game.net.data.StoC {
	...
	public dynamic final class SCGroupBattleEnter extends com.protobuf.Message {
		...
		public var playerList:Vector.<GroupBattlePlayerData> = new Vector.<GroupBattlePlayerData>();
		 ...
		 /**
		  *@inspireLevel   inspireLevel
		  **/
		public var inspireLevel:uint;
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					break;
				case 3:
					if (inspireLevel$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCGroupBattleEnter.inspireLevel cannot be set twice.');
					}
					++inspireLevel$count;
					inspireLevel = com.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 4:
					if (totalWin$count != 0) {
