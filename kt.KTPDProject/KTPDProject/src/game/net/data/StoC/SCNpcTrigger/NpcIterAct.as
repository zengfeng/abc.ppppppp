package game.net.data.StoC.SCNpcTrigger {
	...
	public dynamic final class NpcIterAct extends com.protobuf.Message {
		...
		override public final function writeToBuffer(output:com.protobuf.WritingBuffer):void {
			...
			com.protobuf.WriteUtils.write$TYPE_UINT32(output, actionStep);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					break;
				case 3:
					if (actionStep$count != 0) {
						throw new flash.errors.IOError('Bad data format: NpcIterAct.actionStep cannot be set twice.');
					}
					++actionStep$count;
					actionStep = com.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				default:
