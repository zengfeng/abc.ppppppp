package game.net.data.StoC {
	...
	public dynamic final class SCAutoDemon extends com.protobuf.Message {
		 /**
		  *@dungeonId   dungeonId
		  **/
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (dungeonId$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCAutoDemon.dungeonId cannot be set twice.');
					}
					++dungeonId$count;
				...
				case 2:
					if (countLeft$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCAutoDemon.countLeft cannot be set twice.');
					}
					++countLeft$count;
				...
				case 3:
					if (result$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCAutoDemon.result cannot be set twice.');
					}
					++result$count;
				...
				case 5:
					if (exp$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCAutoDemon.exp cannot be set twice.');
					}
					++exp$count;
