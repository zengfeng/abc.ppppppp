package game.net.data.StoC {
	...
	public dynamic final class SCPlayerInfo extends com.protobuf.Message {
		...
		public var totalConsume:uint;
		 ...
		 /**
		  *@dungeonOpened   dungeonOpened
		  **/
		public var dungeonOpened:Vector.<uint> = new Vector.<uint>();

		 /**
		  *@dungeonGold   dungeonGold
		  **/
		public var dungeonGold:uint;
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			dungeonOpened = new Vector.<uint>();

			var dungeonGold$count:uint = 0;
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 20:
					if ((tag & 7) == com.protobuf.WireType.LENGTH_DELIMITED) {
						com.protobuf.ReadUtils.readPackedRepeated(input, com.protobuf.ReadUtils.read$TYPE_UINT32, dungeonOpened);
						break;
					}
					dungeonOpened.push(com.protobuf.ReadUtils.read$TYPE_UINT32(input));
					break;
				case 21:
					if (dungeonGold$count != 0) {
						throw new flash.errors.IOError('Bad data format: SCPlayerInfo.dungeonGold cannot be set twice.');
					}
					++dungeonGold$count;
					dungeonGold = com.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 29:
					if (tradecnt$count != 0) {
