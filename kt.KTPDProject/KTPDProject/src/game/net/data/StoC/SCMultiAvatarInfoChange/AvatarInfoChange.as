package game.net.data.StoC.SCMultiAvatarInfoChange {
	...
	public dynamic final class AvatarInfoChange extends com.protobuf.Message {
		...
		public function set ride(value:uint):void {
			hasField$0 |= 0x4;
			ride$field = value;
		}

		public function get ride():uint {
			return ride$field;
		}
		...
		override public final function writeToBuffer(output:com.protobuf.WritingBuffer):void {
			...
			if (hasRide) {
				...
				com.protobuf.WriteUtils.write$TYPE_UINT32(output, ride$field);
			}
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 7:
					if (ride$count != 0) {
						throw new flash.errors.IOError('Bad data format: AvatarInfoChange.ride cannot be set twice.');
					}
					++ride$count;
					ride = com.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				default:
