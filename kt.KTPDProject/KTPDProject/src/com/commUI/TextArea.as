package com.commUI
{
    ...
    public class TextArea extends GComponent
    {
        ...
        {
//            //trace("PAGE_SIZE = " + PAGE_SIZE + "  textScrollMax = " + textScrollMax + "   tf.scrollV = " + tf.scrollV + "  tf.textHeight = " + tf.textHeight + " tf.numLines = " + tf.numLines + "    scrollBar.value = " + scrollBar.value);
        }
    }
}
