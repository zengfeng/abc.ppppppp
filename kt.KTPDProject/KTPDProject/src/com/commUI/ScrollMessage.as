package com.commUI
{
	...
	public class ScrollMessage
	{
		...
		{
			if (!AnimalManager.instance.selfPlayer || !(AnimalManager.instance.selfPlayer.avatar as AvatarPlayer)) return;
			(AnimalManager.instance.selfPlayer.avatar as AvatarMySelf).sorollMsg(_message.shift());
		}
