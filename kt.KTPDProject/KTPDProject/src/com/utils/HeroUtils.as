package com.utils
{
	...
	public class HeroUtils
	{
		...
		{
			if (a.id == UserData.instance.myHero.id) return -1;
			if (b.id == UserData.instance.myHero.id) return 1;
...
//			return 0;
		...
		public static function filterOtherHeroColor(hero :VoHero, index:int, vector:Vector.<VoHero>):Boolean
		{
