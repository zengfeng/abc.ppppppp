package com.utils
{
	...
	public class UrlUtils
	{
		...
		/** 玩家头像文件夹路径 */
		private static var DIR_PLAYER_HEAD_PHOTO : String = ROOT + "assets/ico/playerHeadPhosto/";
		/** 玩家头像文件夹路径 */
		...
		/** 副本层图标文件夹路径*/
		private static var DIR_DUNGEON_LAYER_ICON : String = ROOT + "assets/ico/dungeonLayer/";
		/** 副本Boss图标文件夹路径*/
		private static var DIR_DUNGEON_ICON : String = ROOT + "assets/ico/BossHeadIcon/";
		/** 副本面板副本封面图片文件夹路径 */
		...
		// 测试
		private static var DIR_CESHI_ICON : String = ROOT + "assets/ico/dungeonLayer/";
		...
		{
			return VersionManager.instance.getUrl(geMapDir(mapId) + "thumbnail.jpg");
		}
		...
		{
			return VersionManager.instance.getUrl(geMapDir(mapId) + "path");
		}
		...
		{
			return VersionManager.instance.getUrl(geMapDir(mapId) + pieceName + ".swf");
		}
		...
		/** 测试 */
		public static function getCeShi(duplId : int) : String
		{
			return VersionManager.instance.getUrl(DIR_CESHI_ICON + duplId + ".png");
		}

		/** 副本层ICON图片件 */
		public static function getDungeonLayerIcon(duplMapId : int) : String
		{
			return VersionManager.instance.getUrl(DIR_DUNGEON_LAYER_ICON + duplMapId + ".png");
		}
		...
		/** [大图]获取玩家头像路径,根据将领ID */
		public static function getPlayerHeadPhotoByHeroId(heroId : uint) : String
		{
			return VersionManager.instance.getUrl(DIR_PLAYER_HEAD_PHOTO + heroId + ".png");
		}

		/** [大图]获取玩家头像路径,根据职业,性别 */
		public static function getPlayerHeadPhotoByJobAndSex(job : uint, isMale : Boolean) : String
		{
			return VersionManager.instance.getUrl(DIR_PLAYER_HEAD_PHOTO + HeroUtils.getIdByMale(job, isMale) + ".png");
		}
