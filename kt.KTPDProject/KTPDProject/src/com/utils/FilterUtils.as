...
//        public static var defaultTextEdgeFilter : GlowFilter = new GlowFilter(0x000000, 0.8, 2, 2, 17, 1, false, false);
        ...
        public static function disableFilter(value : Number = 0.7) : ColorMatrixFilter
        {
            if (_disableFilter == null)
            {
                _disableFilter = new ColorMatrixFilter([
				0.3086 * value + 1 - value , 0.6094 * value, 0.0820 * value, 0, 0, 
				0.3086 * value, 0.6094 * value + 1 - value, 0.0820 * value, 0, 0, 
				0.3086 * value, 0.6094 * value, 0.0820 * value + 1 - value, 0, 0, 
				0, 0, 0, 1, 0]);
            }
