...
{
	import maps.elements.animations.PlayerAnimation;
	import maps.elements.animations.PlayerAnimationPool;
	...
	public class Player extends Element
	{
		...
		public function reset(playerId : int, name : String, colorStr : String, heroId : int, clothId : int, rideId : int) : void
		{
		...
		// 龟仙拜佛
		// =======================
		public function convoyModelIn(quality : int, isFast : Boolean) : void
		{
			rideUp(1);
			animation.stand();
			turtle = new Turtle();
			turtle.reset(quality, name, colorStr);
